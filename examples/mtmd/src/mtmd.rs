...
use fellhorn_llama_cpp_2::context::LlamaContext;
...
use fellhorn_llama_cpp_2::model::{LlamaChatMessage, LlamaChatTemplate, LlamaModel, Special};
        ...
        let mtmd_params = MtmdContextParams {
            ...
            media_marker: CString::new(
                params
                    .media_marker
                    .as_ref()
                    .unwrap_or(&fellhorn_llama_cpp_2::mtmd::mtmd_default_marker().to_string())
                    .clone(),
            )?,
        };
...
fn run_single_turn(
    ...
    let default_marker = fellhorn_llama_cpp_2::mtmd::mtmd_default_marker().to_string();
