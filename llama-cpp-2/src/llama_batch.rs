...
use fellhorn_llama_cpp_sys_2::{llama_batch, llama_batch_free, llama_batch_init, llama_pos, llama_seq_id};
...
pub struct LlamaBatch {
    ...
    /// The llama_cpp batch. always initialize by `fellhorn_llama_cpp_sys_2::llama_batch_init(allocated, <unknown>, <unknown>)`
...
impl LlamaBatch {
    ...
    pub fn get_one(tokens: &[LlamaToken]) -> Result<Self, BatchAddError> {
        ...
        let batch = unsafe {
            ...
            fellhorn_llama_cpp_sys_2::llama_batch_get_one(
                ptr,
                tokens
                    .len()
                    .try_into()
