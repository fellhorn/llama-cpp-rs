...
pub struct LlamaModelParams {
    pub(crate) params: fellhorn_llama_cpp_sys_2::llama_model_params,
    kv_overrides: Vec<fellhorn_llama_cpp_sys_2::llama_model_kv_override>,
}
...
impl LlamaModelParams {
    ...
    pub fn append_kv_override(
        ...
        self.kv_overrides
            .push(fellhorn_llama_cpp_sys_2::llama_model_kv_override {
                key: [0; 128],
                tag: 0,
                __bindgen_anon_1: fellhorn_llama_cpp_sys_2::llama_model_kv_override__bindgen_ty_1 {
                    val_i64: 0,
                },
            });
...
impl Default for LlamaModelParams {
    fn default() -> Self {
        let default_params = unsafe { fellhorn_llama_cpp_sys_2::llama_model_default_params() };
        LlamaModelParams {
