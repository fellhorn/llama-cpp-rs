        ...
        ParseState {
            ...
            rules: vec![vec![
                llama_grammar_element {
                    type_: fellhorn_llama_cpp_sys_2::LLAMA_GRETYPE_CHAR,
                    value: 'c' as u32,
                },
                llama_grammar_element {
                    type_: fellhorn_llama_cpp_sys_2::LLAMA_GRETYPE_CHAR,
                ...
                llama_grammar_element {
                    type_: fellhorn_llama_cpp_sys_2::LLAMA_GRETYPE_END,
                    value: 0,
                }
            ]],
        },
    ...
    assert_eq!(
        ParseState {
            ...
            rules: vec![vec![
                ...
                llama_grammar_element {
                    type_: fellhorn_llama_cpp_sys_2::LLAMA_GRETYPE_CHAR_RNG_UPPER,
                    value: 'z' as u32
                },
                llama_grammar_element {
                    type_: fellhorn_llama_cpp_sys_2::LLAMA_GRETYPE_CHAR_ALT,
                    value: 'A' as u32
                },
                llama_grammar_element {
                    type_: fellhorn_llama_cpp_sys_2::LLAMA_GRETYPE_CHAR_RNG_UPPER,
