...
impl LlamaContext<'_> {
    ...
    pub fn copy_cache(&mut self, src: i32, dest: i32, size: i32) {
        let mem = unsafe { fellhorn_llama_cpp_sys_2::llama_get_memory(self.context.as_ptr()) };
        unsafe { fellhorn_llama_cpp_sys_2::llama_memory_seq_cp(mem, src, dest, 0, size) }
    }
    ...
    pub fn copy_kv_cache_seq(
        ...
        let mem = unsafe { fellhorn_llama_cpp_sys_2::llama_get_memory(self.context.as_ptr()) };
        unsafe { fellhorn_llama_cpp_sys_2::llama_memory_seq_cp(mem, src, dest, p0, p1) };
        Ok(())
    }
    ...
    pub fn clear_kv_cache_seq(
        ...
        let p1 = p1
            ...
            .map_err(KvCacheConversionError::P1TooLarge)?;
        let mem = unsafe { fellhorn_llama_cpp_sys_2::llama_get_memory(self.context.as_ptr()) };
        Ok(unsafe { fellhorn_llama_cpp_sys_2::llama_memory_seq_rm(mem, src, p0, p1) })
    }
    ...
    pub fn clear_kv_cache(&mut self) {
        ...
        unsafe { fellhorn_llama_cpp_sys_2::llama_memory_clear(mem, true) }
    }
    ...
    pub fn llama_kv_cache_seq_keep(&mut self, seq_id: i32) {
        let mem = unsafe { fellhorn_llama_cpp_sys_2::llama_get_memory(self.context.as_ptr()) };
        unsafe { fellhorn_llama_cpp_sys_2::llama_memory_seq_keep(mem, seq_id) }
    }
    ...
    pub fn kv_cache_seq_add(
        ...
        let p1 = p1
            ...
            .map_err(KvCacheConversionError::P1TooLarge)?;
        let mem = unsafe { fellhorn_llama_cpp_sys_2::llama_get_memory(self.context.as_ptr()) };
        unsafe { fellhorn_llama_cpp_sys_2::llama_memory_seq_add(mem, seq_id, p0, p1, delta) };
        Ok(())
    }
    ...
    pub fn kv_cache_seq_div(
        ...
        let mem = unsafe { fellhorn_llama_cpp_sys_2::llama_get_memory(self.context.as_ptr()) };
        unsafe { fellhorn_llama_cpp_sys_2::llama_memory_seq_div(mem, seq_id, p0, p1, d) }
        Ok(())
    }
    ...
    pub fn kv_cache_seq_pos_max(&self, seq_id: i32) -> i32 {
        let mem = unsafe { fellhorn_llama_cpp_sys_2::llama_get_memory(self.context.as_ptr()) };
        unsafe { fellhorn_llama_cpp_sys_2::llama_memory_seq_pos_max(mem, seq_id) }
    }
}
